...
if '/* ── 4. SOCIAL SHARE BUTTONS ── */' not in js_content:
    insert_point = js_content.rfind('})();')
    if insert_point != -1:
        new_content = js_content[:insert_point] + share_css_and_js + js_content[insert_point:]
        with open('enhancements.js', 'w', encoding='utf-8') as f:
            f.write(new_content)
        print("Added share buttons to enhancements.js")
